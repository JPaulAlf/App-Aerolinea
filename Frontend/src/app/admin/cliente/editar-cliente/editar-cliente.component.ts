...
export class EditarClienteComponent implements OnInit {
  ...
  constructor( private aRoute: ActivatedRoute, private sanitizer: DomSanitizer, private toastr:ToastrService, private _usuarioService: UsuarioService, private router: Router) {
